...
public class Constants {
    ...
    public static final String WAITTING_DEAL = "1";
    public static final String RELFCT_DEAL = "2";
    public static final String REVERSE_DEAL = "3";
    public static final String FIX_DEAL = "4";
    public static final String END_DEAL = "5";
}
